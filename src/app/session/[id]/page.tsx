        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
              {/* Instagram Preview */}
              <div className="card">
                <h3 className="font-semibold text-woody-primary mb-4">Instagram Voorbeeld</h3>
                <div className="bg-black rounded-2xl p-1 mx-auto" style={{ width: '320px' }}>
                  <div className="bg-white rounded-xl overflow-hidden">
                    {/* Phone frame */}
                    <div className="bg-gray-900 aspect-video rounded-lg overflow-hidden mb-2">
                      {state.selectedImages.length > 0 && (
                        <Image
                    ...
                    <div className="p-3 text-xs">
                      <div className="font-semibold text-gray-900 mb-2">woodykids_shop</div>
                      <div className="text-gray-800 line-clamp-3 whitespace-pre-wrap text-xs">
                        {caption}
                      </div>
                    </div>
                  </div>
